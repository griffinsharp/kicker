...
class newProjectForm extends React.Component {
  ...
  renderNumCount() {
    ...
    return <div className="page-count">{count}</div>;
  }
  ...
  handleSubmit(e) {
    ...
    const newReward0 = Object.assign(
      {},
      {
        amount: 10,
        desc: "This is the filler reward.",
        subdesc: "Nothing.",
        delivery: "2 Weeks",
        shipping: "Domestic",
        num_backers: 0,
        project_id: this.state.newProjId
      }
    );
    const newReward1 = Object.assign(
      {},
      {
        amount: 10,
        desc: "This is the basic reward.",
        subdesc:
          "Most projects will have something worth contributing for here, but nothing major.",
        delivery: "2 Weeks",
        shipping: "Domestic",
        num_backers: 0,
        project_id: this.state.newProjId
    ...
    const newReward2 = Object.assign(
      {},
      {
        amount: 50,
        desc: "This is a middle tier reward.",
        subdesc: "This is where things start getting interesting.",
        delivery: "2 Weeks",
        shipping: "Domestic",
        num_backers: 0,
        project_id: this.state.newProjId
    ...
    const newReward3 = Object.assign(
      {},
      {
        amount: 500,
        desc: "This is the whole enchilada.",
        subdesc: "This is what you really want people to buy.",
        delivery: "2 Weeks",
        shipping: "Domestic",
        num_backers: 0,
        project_id: this.state.newProjId
    ...
    this.props
      ...
      .then(() =>
        this.props
          .createReward(newReward0)
          .then(() =>
            this.props
              .createReward(newReward1)
              .then(() =>
                this.props
                  .createReward(newReward2)
                  .then(() =>
                    this.props
                      .createReward(newReward3)
                      .then(() =>
                        this.props
                          .fetchProjects()
                          .then(() =>
                            this.props.history.push(
                              `/projects/${this.state.newProjId}`
                            )
                          )
                      )
                  )
        ...
        <div className="new-proj-container">
          ...
          <div className={this.state.categorySelect}>
            ...
            <form className="dropform">
              <div
                className={`session-type-input-proj-drop ${this.state.formColor}`}
          ...
          <div className={this.state.infoSelect}>
            ...
            <div className="">
              <form className="info-form">
                ...
                <textarea
                  className="session-type-input-info-short"
                  onChange={this.update("title")}
                  type="text"
                  placeholder="The Community Shoe Kit"
                ></textarea>
                <div className="box-header">Subtitle</div>
                <textarea
                  className="session-type-input-info-short"
                  onChange={this.update("sub_title")}
                  type="text"
                  placeholder="Explore the shoe world around you with an affordable show kit you construct yourself."
                ></textarea>
                <div className="box-header">Description</div>
                <textarea
                  className="session-type-input-info"
                  onChange={this.update("campaign")}
                  type="text"
                  placeholder="From Nike to Adidas, a strange and fantastic world surrounds us. Working with people around the world, The Shoe Company has developed an affordable way to peek into this hidden world."
                ></textarea>
          ...
          <div className={this.state.locationSelect}>
            <div>
              ...
              <form className="info-form">
                <textarea
                  ...
                  type="text"
                  placeholder="Born on Kickstarter in 2013, The Shoe Company is a San Francisco-based startup in love with shoes and obsessed with product design."
                ></textarea>
              </form>
            </div>
            <div className="page-3-info">
            ...
            <form className="dropform">
              <div
                className={`session-type-input-proj-drop ${this.state.formColorTwo}`}
                onClick={() => this.selectLoc()}
              >
                {this.state.dropdowntwo}
                <FontAwesomeIcon
                  className="caret-svg"
                  icon={faCaretDown}
                  alt=""
              ...
              <div className={this.state.catboxtwo}>
                ...
                <div
                  onClick={() => this.updatedroptwo("Norway")}
                  className="cat-box-option"
                >
                  Norway
                </div>
          ...
          <div className={this.state.fundingSelect}>
            <div className="cat-header">
              <h1>Finally, set a funding goal & campaign duration.</h1>
            </div>
            <div className="cat-sub-header">
              Set an achievable goal that covers what you need to complete your
              project within the chosen amount of time. Funding is
              all-or-nothing. If you don’t meet your goal, you won’t receive any
              money.
            </div>
            <form className="info-form-final" onSubmit={this.handleSubmit}>
              ...
              <div className="funding-box">
                ...
                <input
                  className="session-type-input-funding"
                  onChange={this.updateNum("goal_amount")}
                  type="number"
                  placeholder="1"
                  min="1"
                  max="100000000"
              ...
              <div className="box-header">Campaign duration</div>

              <label className="radio-box">
                <input
                  className="radio-session-type-input"
                  onChange={this.updateRadio("days_left")}
                  name="group1"
                  type="radio"
                  value="30"
