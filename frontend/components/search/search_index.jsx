    ...
    this.props.fetchProjects().then(() => {
      if (this.state.category_id === "") {
        ...
        results = projects.filter(
          project => this.state.category_id == project.category_id
        );
      }
          ...
          <div className="proj-and-amt">
            <div className="proj-search-container">
              <div className="no-search-result">
                Oops! Looks like we couldn’t find any results. Why not change
                some things around or broaden your search?
              </div>
            </div>
          </div>
        );
