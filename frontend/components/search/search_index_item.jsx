      ...
      <div className="search-index-item">
        <div className="search-img-container">
          <Link to={`/projects/${project.id}`}>
            <img
              className="search-index-item-pic"
        ...
        <div className="search-index-item-text">
          <div className="search-index-item-info">
            ...
            <div className="search-index-item-subtitle">
              {project.sub_title}
            </div>
            <p className="search-author">
              by{" "}
              <Link to={`/projects/${project.id}`}>{project.authorName}</Link>
            </p>
          </div>
          <div className="search-index-item-bottom">
            ...
            <div className="search-perc-funded">
              {this.percentFunded(project.newPledgeAmount, project.goal_amount)}
              % funded
            </div>
            <div className="search-days-left">
              {project.days_left} days to go
            </div>
            <Link
              className="search-info-cat"
              to={{
                pathname: "/search",
                state: {
                  category_id: "",
                  location: `${project.lcategory}`,
                  filter: "",
                  filtprojects: ""
                }
              }}
